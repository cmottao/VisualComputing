...
function Model({ url, viewMode, onModelLoad }) {
...
export default function ModelViewer({ modelPath, viewMode, onModelLoad }) {
  if (!modelPath) {
    return (
      <Canvas
  ...
  return (
    ...
    >
      ...
      <Model url={modelPath} viewMode={viewMode} onModelLoad={onModelLoad} />
